...
def makePlot(filename,x,y,xlab,ylab,title,legend=None,xlim=None,\
             ylim=None,figsize=(14,6),semilog=False,annotations=None):
...
for i,time in enumerate(times):
    ...
    if (time % 5.000 == 0.0): # all other sampling increments divide 5 ka evenly.
